        ...
        <div class="w-full max-w-xl">
            ...
            <div class="bg-white/[0.06] backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl p-8 md:p-10 fade-up-2">
                ...
                <form method="POST" action="/kiosk/camera" class="space-y-5">
                    ...
                    {{-- STAFF TUJUAN --}}
                    <div class="fade-up-4">
                        <label for="staff_id" class="block text-sm font-semibold text-slate-300 mb-2">
                        ...
                        <div class="relative input-glow rounded-xl transition-shadow duration-200">
                            ...
                            <select id="staff_id" name="staff_id" required
                                class="block w-full pl-12 pr-10 py-3.5 rounded-xl border border-white/10 bg-white/[0.04] text-white focus:bg-white/[0.08] focus:border-blue-500/50 focus:ring-blue-500/20 focus:ring-4 transition-all duration-200 text-sm appearance-none cursor-pointer">
                                <option value="" class="bg-slate-800 text-slate-400">— Pilih Staff Tujuan —</option>
                                @foreach($staffs as $staff)
                                    <option value="{{ $staff->id }}" class="bg-slate-800 text-white">{{ $staff->name }}</option>
                                @endforeach
                            </select>
