            ...
            @forelse($visitors as $visitor)
                @php
                    ...
                    $statusBadgeMap = [
                        ...
                        'in'       => 'bg-blue-500/10 text-blue-400 border-blue-500/20',
                    ];
                    $statusBadge = $statusBadgeMap[$statusType];
                @endphp
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-[10px] font-semibold px-2 py-0.5 rounded-full border {{ $statusBadge }}">{{ $visitor->status }}</span>
                                @if($isOverdue)
