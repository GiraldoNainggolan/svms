        ...
        <div class="divide-y divide-white/[0.03]">
            @forelse($logs as $log)
                <div class="flex items-start gap-4 px-6 py-4 hover:bg-white/[0.01] transition-colors">
                    ...
                    {{-- ICON --}}
                    <div class="w-9 h-9 mt-0.5 rounded-xl flex items-center justify-center flex-shrink-0
                        ...
                        @elseif(str_contains($log->action, 'login')) bg-violet-500/10
                        ...
                        @elseif(str_contains($log->action, 'checkin'))
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex items-center gap-3 mt-1.5">
                            ...
                            <span class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium
                                @if(str_contains($log->action, 'create')) bg-emerald-500/10 text-emerald-400
                                @elseif(str_contains($log->action, 'delete')) bg-red-500/10 text-red-400
                                @elseif(str_contains($log->action, 'checkin')) bg-blue-500/10 text-blue-400
                                @elseif(str_contains($log->action, 'checkout')) bg-amber-500/10 text-amber-400
