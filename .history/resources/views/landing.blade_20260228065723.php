...
<head>
    ...
    <title>SVMS — School Visitor Management System</title>
...
<div class="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 text-white flex flex-col relative overflow-hidden">
    ...
    <section class="relative z-10 pb-12 px-6 md:px-12">
        ...
        {{-- SECTION HEADING --}}
        <div class="max-w-6xl mx-auto mb-8 fade-up-3">
            <div class="flex items-center gap-3">
                <div class="h-px flex-1 bg-gradient-to-r from-transparent via-slate-700 to-transparent"></div>
                <span class="text-xs font-semibold tracking-widest uppercase text-slate-500">Pilih Akses</span>
                <div class="h-px flex-1 bg-gradient-to-r from-transparent via-slate-700 to-transparent"></div>
            </div>
        </div>
                ...
                <div class="relative">
                    ...
                    <div class="flex items-center gap-4 text-xs text-slate-400 mb-6">
                        <span class="flex items-center gap-1.5">
                            <svg class="w-3.5 h-3.5 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" /></svg>
                            Cepat & Mudah
                        </span>
                        <span class="flex items-center gap-1.5">
                            <svg class="w-3.5 h-3.5 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" /></svg>
               ...
               class="fade-up-5 group relative bg-white/[0.06] backdrop-blur-xl border border-white/10 rounded-2xl p-8 md:p-10 shadow-xl hover:shadow-2xl hover:shadow-violet-500/10 hover:scale-[1.02] hover:bg-white/[0.1] transition-all duration-500 card-glow-purple overflow-hidden">
                ...
                <div class="relative">
                    ...
                    <div class="flex items-center gap-4 text-xs text-slate-500 mb-6">
                        <span class="flex items-center gap-1.5">
                            <svg class="w-3.5 h-3.5 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" /></svg>
                            Dashboard
                        </span>
                        <span class="flex items-center gap-1.5">
                            <svg class="w-3.5 h-3.5 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" /></svg>
