...
<head>
    ...
    <title>@yield('title', 'Security') — SVMS</title>
    ...
    <aside class="w-[260px] bg-[#0d1220] border-r border-white/[0.06] flex flex-col fixed inset-y-0 left-0 z-30">
        ...
        <div class="px-6 py-6 border-b border-white/[0.06]">
            <div class="flex items-center gap-3">
                <div class="w-9 h-9 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-xl flex items-center justify-center">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-slate-500 uppercase tracking-widest">Security Panel</p>
                </div>
            </div>
        </div>
        ...
        <nav class="flex-1 px-4 py-5 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('security.dashboard') }}"
               class="sidebar-link {{ request()->routeIs('security.dashboard') ? 'active' : 'text-slate-400' }}">
            ...
            <a href="{{ route('security.activity') }}"
               class="sidebar-link {{ request()->routeIs('security.activity') ? 'active' : 'text-slate-400' }}">
                <svg class="icon" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
            ...
            <a href="{{ route('security.profile') }}"
               class="sidebar-link {{ request()->routeIs('security.profile') ? 'active' : 'text-slate-400' }}">
                <svg class="icon" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
        ...
        <div class="px-4 py-4 border-t border-white/[0.06]">
            <div class="flex items-center gap-3 px-2">
                <div class="w-8 h-8 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-lg flex items-center justify-center text-xs font-bold">
    ...
    <main class="flex-1 ml-[260px]">
        ...
        <header class="sticky top-0 z-20 bg-[#0a0e1a]/80 backdrop-blur-xl border-b border-white/[0.06] px-8 py-4">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-bold">@yield('page-title', 'Security Dashboard')</h2>
