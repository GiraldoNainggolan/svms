...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware('role:staff')->prefix('staff')->name('staff.')->group(function () {
        ...
        Route::get('/visitors',      [StaffController::class, 'visitors'])->name('visitors');
        Route::get('/history',       [StaffController::class, 'history'])->name('history');
        Route::get('/profile',       [StaffController::class, 'profile'])->name('profile');
        Route::patch('/accept/{visitor}',  [StaffController::class, 'accept'])->name('accept');
        Route::patch('/reject/{visitor}',  [StaffController::class, 'reject'])->name('reject');
    });
});
